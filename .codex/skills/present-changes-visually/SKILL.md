...
This project is an introductory Java project. Include Java source, test, and
documentation changes in the generated diff, while keeping the visualisation
workflow independent of the Java build system. Do not modify source files just
...
When a commit is also requested, use a concise imperative subject and explain
the purpose of the change in the body when the change is substantial.
